...
(function () {
    ...
    Array.prototype.indexOfAttr = function (e, t) {
        ...
        for (var i = 0, s = this.length; i < s; i++) if (n == "string" && this[i][e] == t || n == "number" && this[i] == e) {
            r = i;
            break
        }
        return n = null, r
    ...
    var n = {
        canvas: {
            ...
            key: 0,
            keys: {
                up: !1, down: !1, left: !1, right: !1, a: !1, b: !1, c: !1, menu: !1, quit: !1
            },
            lastKey: {
                up: !1, down: !1, left: !1, right: !1, a: !1, b: !1, c: !1, menu: !1, quit: !1
            },
            ...
            keyPressCtrl: {
                up: !0, down: !0, left: !0, right: !0, a: !0, b: !0, c: !0, menu: !0, quit: !0
            },
            keyDownGo: !1,
            keyUpGo: !1,
            keyPressedGo: !1,
            ...
            imgs: {}, imgObjs: [], initImgs: {}, asyncImgObjs: {}, imgCount: 0, countLoaded: 0, version: "", inited: !1
        }, audio: {
            audios: {}
        }, ajax: {
            xhrObj: null, pool: [], poolLength: 5, date: null, isTimeout: !1, param: {
                type: "get", data: null, dataType: "json", url: "", xhr: null, timeout: 5e3, before: function (e) {
            ...
            buttons: [], Button: t(function (e) {
                ...
                refresh: function () {
                    ...
                    if (this.value != "") {
                        var e = m.canvas.font(this.font).measureText(this.value), t = this.width - e.width >> 1,
        ...
        canvas: {
            ...
            key: {
                up: 38, down: 40, left: 37, right: 39, a: 90, b: 88, c: 67, menu: 49, quit: 50
            }
        }, system: {
            gameFlowType: {
                menu: 0, run: 1, stop: 2, over: 3, zone: 4, active: 5, loadImage: 6, loadedImage: 7
            }
        }
    }, i = {
        getCanvasDom: function () {
            ...
            if (n.event.swipeDate) {
                if (Date.now() - n.event.swipeDate < n.event.swipeTimeout) if (Math.abs(e - n.event.pageStarOffX) >= n.event.swipeRange || Math.abs(t - n.event.pageStarOffY) >= n.event.swipeRange) return n.event.swipeCallBack(n.event.pageStarOffX, n.event.pageStarOffY, e, t), !0;
            ...
            var t = i.getOffsetX(e), r = i.getOffsetY(e);
            ...
            return e.indexOf("duopaosafari") != -1 ? {
                device: "duopaoSafari", fps: 1, touch: !0, zoom: 1
            } : e.indexOf("iphone") != -1 || e.indexOf("ipod") != -1 ? {
                device: "iphone", fps: 1, touch: !0, zoom: 1
            } : e.indexOf("ipad") != -1 ? {
                device: "ipad", fps: 1, touch: !0, zoom: 1
            } : e.indexOf("duopaoandroid") != -1 ? {
                device: "duopaoAndroid", fps: 1, touch: !0, zoom: 1
            } : e.indexOf("duopaowindowsphone") != -1 ? {
                device: "duopaoWindowsPhone", fps: 1, touch: !0, zoom: 1
            } : e.indexOf("opera mobi") != -1 ? {
                device: "operamobile", fps: 1, touch: !0, zoom: 1
            } : e.indexOf("flyflow") != -1 ? {
                device: "flyflow", fps: 1, touch: !0, zoom: 1
            } : e.indexOf("android") != -1 ? {
                device: "android", fps: 1, touch: !0, zoom: 1
            } : e.indexOf("iemobile") != -1 ? {
                device: "iemobile", fps: 1, touch: !1, zoom: 1
            } : e.indexOf("j2me") != -1 ? {
                device: "j2me", fps: 1, touch: !1, zoom: 1
            } : e.indexOf("symbian v5") != -1 ? {
                device: "symbian5", fps: 1, touch: !0, zoom: 1
            } : e.indexOf("symbian v3") != -1 ? {
                device: "symbian3", fps: 1, touch: !1, zoom: 1
            } : e.indexOf("chrome") != -1 ? {
                device: "chrome", fps: 1, touch: !1, zoom: 1
            } : e.indexOf("firefox") != -1 ? {
                device: "firefox", fps: 1, touch: !1, zoom: 1
            } : e.indexOf("msie") != -1 ? {
                device: "ie", fps: .5, touch: !1, zoom: 1
            } : e.indexOf("windows") != -1 ? {
                device: "ie", fps: .5, touch: !1, zoom: 1
            } : e.indexOf("safari") != -1 ? {
                device: "safari", fps: 1, touch: !1, zoom: 1
            } : e.indexOf("opera") != -1 ? {
                device: "opera", fps: 1, touch: !1, zoom: 1
            } : {
            ...
            var e = n.buttonLayout.buttons, t;
            for (var r = e.length - 1; r >= 0; r--) if (t = e[r]) t.action().render(), t.goned && t.endPath() && e.splice(r, 1);
            e = t = null
        }, buttonLayoutEventHandler: function (e, t, r) {
            var i = n.buttonLayout.buttons, s, o = !1;
    ...
    link = {
        init: function (e, t) {
            ...
            e && n.ajax.pool.length < n.ajax.poolLength && n.ajax.pool.push(e), e && e.clear && (n.ajax.pool = []), n.ajax.xhr || (n.ajax.xhr = new XMLHttpRequest, n.ajax.xhr.onreadystatechange = function () {
                ...
                var e = n.ajax.xhr, t = n.ajax.xhrObj;
                if (t && e.readyState == 4) {
            ...
            if (n.ajax.xhrObj == null && n.ajax.pool.length > 0) {
                ...
                var t = n.ajax.xhr, r = n.ajax.xhrObj, i = n.ajax.xhrObj.url, s = null, o = r.data;
                r.type = r.type.toUpperCase(), r.dataType = r.dataType.toUpperCase(), n.ajax.isTimeout = !1;
                if (typeof o == "string") s = o; else if (typeof o == "object") {
                    s = [];
            ...
            var e = this.clone(arguments[0]) || {}, t = 1, n = arguments.length, r = !1, i;
            ...
            registerNotify: function (e, t) {
                ...
                var o = Math.abs(e - r), u = Math.abs(t - i);
                ...
                var n = 50, r = 50, i, s, o = Math.PI / 180 * t, u = Math.sin(o), a = Math.cos(o);
                for (var f = 0; f < e.length; f++) i = e[f][0], s = e[f][1], e[f][0] = a * i - u * s, e[f][1] = u * i + a * s;
                return this
            }, createPath: function (e, t, n, r, i) {
                var s = [], o = e || 0, u = t || 0, a = n || 0, f = r || 0, l = a - o, c = f - u,
                    h = Math.sqrt(Math.pow(l, 2) + Math.pow(c, 2)), p = i || 5, d = p, v = 0, m = 0, g, y,
                ...
                switch (n.system.gameFlow) {
                    ...
                    case r.system.gameFlowType.loadImage:
                        if (i.loadingCallBack != null) {
                            var t = n.image.imgCount, s = n.image.countLoaded > t ? t : n.image.countLoaded;
            ...
            init: function () {
                return o = {
                    ...
                    x: 0, y: 0, fillStyle: "#FFFFFF", strokeStyle: "#CCCCCC"
                }, this.pass()
            }, initDevice: function () {
                ...
                var d = m.getImage(e);
                if (d.refreshed) this.drawCache(e, t, r, u, a, f, l, c, h, p); else if (d.src != null) c != null && (t = t < 0 ? 0 : t, c = c <= 0 ? .1 : c), h != null && (r = r < 0 ? 0 : r, h = h <= 0 ? .1 : h), u != null && c != null && (u = u <= 0 ? .1 : t + u <= d.width ? u : d.width - t), a != null && h != null && (a = a <= 0 ? .1 : r + a <= d.height ? a : d.height - r), d.loaded && (u ? a ? p ? (o = i.getAnchor(f, l, c, h, p), s.drawImage(d, t, r, u, a, o.x, o.y, c, h)) : s.drawImage(d, t, r, u, a, f, l, c, h) : (o = i.getAnchor(t, r, d.width, d.height, u), s.drawImage(d, o.x, o.y)) : s.drawImage(d, t, r)); else {
                ...
                var h = parseInt(f >> 1), p = parseInt(l >> 1), d = m.getImage(e),
                ...
                var c = m.getImage(e), h = c.cache ? this.drawCache : this.drawImage;
                ...
                var p = m.getImage(e), d = p.cache ? this.drawCache : this.drawImage;
                return d(e, t, n, i, o, 0, 0, c, h), s.setTransform(1, 0, 0, 1, 0, 0), d = null, p = null, this
            }, drawNumber: function (e, t, n, r, i, s, o, u, a) {
                var f = e.toString(), l = f.length, c = u ? u : n, h = a ? a : r;
                if (o == "center") {
                    var d = i + parseInt(p - c * l >> 1);
                    for (var v = 0; v < l; v++) this.drawImage(t, parseInt(f.charAt(v)) * n, 0, n, r, d + v * c, s, c, h);
                    d = null
                } else if (o == 1) for (var v = 0; v < l; v++) this.drawImage(t, parseInt(f.charAt(v)) * n, 0, n, r, i + v * c, s, c, h); else if (o == 0) for (var v = l - 1; v >= 0; v--) this.drawImage(t, parseInt(f.charAt(v)) * n, 0, n, r, i - (l - 1 - v) * c, s, c, h, m.graphics.ANCHOR_RT);
                ...
                var t = s.measureText(e), n = t.width, r = t.height ? t.height : parseInt(s.font);
                return {
                    width: this.screen.getDevice() == "j2me" ? s.measureText(e) : n, height: r
                }
            ...
            return n.image.imgs[e] && (n.image.imgs[e] = null, delete n.image.imgs[e], t && (n.image.imgs[e] = {
                id: e, loaded: !0, cache: !0, refreshed: !0
            })), this
        }, audio: {
            play: function (e) {
            ...
            create: function (e) {
                ...
                var e = n.buttonLayout.buttons, t;
                for (var r = e.length - 1; r >= 0; r--) if (t = e[r]) t.disposed(), e.splice(r, 1);
    ...
    var m = jsGame = link, g = document.getElementsByTagName("head")[0], y = null, b = null, w = null, E = null,
        S = function () {
    ...
    link.getNewGuid = function () {
        ...
        e && (this.time = this._initTime, this._dateTime = Date.now()), this.stop(), this.timeout = setTimeout(function (e) {
            var t = Date.now(), n = parseInt(Math.round((t - e._dateTime) / e.millisec));
        ...
        if (s.length > 0) {
            ...
            for (var a = 0; a < s.length; a++) {
                ...
                for (var f = 0; f < u.length; f++) i.push({
                    args: [u[f][0], u[f][1], u[f][2]], step: u[f][3]
                });
    ...
    e.action = {}, e.action.Role = function (e, t, r, i, s, o, u, a) {
        ...
        var f = this.getSprite(), l = f.getFrame(), c = this.frames[l.args[0]];
        this._fA = c.fA, this.aR = c.aR, this.bR = c.bR, this._skipMoveDs = !1, this._stopedAction = null, c = l = f = null, this.onend = null, this.onstart = null, this._locked = !1, this.speed = 5, this.links = [], this.polyAR = [[0, 0], [0, 0], [0, 0], [0, 0]], this.aabbAR = [[0, 0], [0, 0], [0, 0], [0, 0]], this.polyBR = [[0, 0], [0, 0], [0, 0], [0, 0]], this.aabbBR = [[0, 0], [0, 0], [0, 0], [0, 0]]
    }, e.action.Role.prototype.setSprite = function (t, n, r) {
        if (this._locked) return this;
        var i = t != undefined ? t : 0, s = i >= 0 ? e.trans.TRANS_NONE : e.trans.TRANS_MIRROR, o, u;
        ...
        if (r && r.args) if (i = this.frames[r.args[0]]) {
            ...
            var s = this.getAttackRect(), o = this.getBodyRect(), u = 0, a = 0, f = 0, l = 0;
            ...
            var c = 0, h = this.polyAR, p = this.aabbAR;
            while (c++ < 2) {
        ...
        var n = this.getSprite();
        if (n && this._fA) {
            var r = this._fA, i = r.length, s = e.canvas, o = n.trans, u, a, f;
            if (this.angle > 0) {
                var l = r[0], c = this.x, h = this.y;
        ...
        return t == null && r.trans != e.trans.TRANS_NONE || t < 0 ? {
            x: -(s[0] + s[2] * this.zoom), y: s[1] * this.zoom, width: s[2] * this.zoom, height: s[3] * this.zoom
        } : {
            x: s[0] * this.zoom, y: s[1] * this.zoom, width: s[2] * this.zoom, height: s[3] * this.zoom
        }
        ...
        return t == null && r.trans != e.trans.TRANS_NONE || t < 0 ? {
            ...
            id: this.id, x: s[0] * this.zoom, y: s[1] * this.zoom, width: s[2] * this.zoom, height: s[3] * this.zoom
        }
    ...
    e.asyncImage([{
        id: "host", src: "images/xiaoren.png"
    }]);
    var t = ["host"], n = [[[0, 0, 26, 37], [27, 0, 19, 36], [46, 0, 22, 38]]], r = [{
        aR: [-15, -30, 30, 30], bR: [-10, -25, 20, 20], fA: [[0, 0, -14, -37, 0]]
    }, {
        aR: [-15, -30, 30, 30], bR: [-10, -25, 20, 20], fA: [[0, 1, -9, -36, 0]]
    }, {
        aR: [-15, -30, 30, 30], bR: [-10, -25, 20, 20], fA: [[0, 2, -12, -37, 0]]
    }], i = [{
        loop: !0, frames: [[0, 0, 0, 0], [1, 0, 0, 0], [2, 0, 0, 0], [1, 0, 0, 0]]
    }];
    return {
        get: function (s, o) {
            var u = s >= 0 && i[s] ? [i[s]] : i;
    ...
    e.asyncImage([{
        id: "shine", src: "images/wu.png"
    }]);
    var t = ["shine"], n = [[[0, 20, 101, 64], [119, 19, 112, 66], [238, 13, 140, 80], [391, 0, 103, 100]]], r = [{
        aR: [-15, -30, 30, 30], bR: [-10, -25, 20, 20], fA: [[0, 0, -51, -34, 0]]
    }, {
        aR: [-15, -30, 30, 30], bR: [-10, -25, 20, 20], fA: [[0, 1, -54, -34, 0]]
    }, {
        aR: [-15, -30, 30, 30], bR: [-10, -25, 20, 20], fA: [[0, 2, -58, -35, 0]]
    }, {
        aR: [-15, -30, 30, 30], bR: [-10, -25, 20, 20], fA: [[0, 3, -49, -45, 0]]
    }], i = [{
        loop: !1, frames: [[0, 0, 0, 0], [1, 0, 0, 0], [2, 0, 0, 0], [3, 0, 0, 0]]
    }];
    return {
        get: function (s, o) {
            var u = s >= 0 && i[s] ? [i[s]] : i;
                    ...
                    render: function () {
                        ...
                        if (!this.hostDied) {
                            ...
                            if (o - this.displayDate >= this.displayTimeout) {
                                this.displayDate = o;
                                var u = e.comm.getRandom(5, 30), a = e.comm.getRandom(10, 50);
                                this.boxes.unshift({
                                    x: this.width, y: 0, width: u, height: a
